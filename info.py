...
API_ID = int(environ.get('API_ID', '29390803'))
API_HASH = environ.get('API_HASH', '29390803')
BOT_TOKEN = environ.get('BOT_TOKEN', "5893948581:AAHtiCeO4oDfxHYz8Rp1N4G2gFfhx_Kn0Wk")
...
auth_channel = environ.get('AUTH_CHANNEL', 'TmGuardians')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://filedtore_bot:qwertyuiop1234567890@cluster0.znzqs0e.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 'TmGuardians'))
